          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@Wrnxt.com" className="hover:text-primary transition-colors">info@Wrnxt.com</a>
              </li>
              <li className="relative flex items-center gap-3" ref={phoneRef}>
                ...
                {showPhoneOptions && (
                  <div className="absolute bottom-full left-0 mb-4 w-48 bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-20 animate-in fade-in slide-in-from-bottom-4 duration-300">
                    <a 
                      href="tel:+918123455500"
                    ...
                    <a 
                      href="https://wa.me/918123455500"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 px-5 py-4 hover:bg-white/5 transition-colors group"
                    >
                      <div className="w-8 h-8 bg-green-500/10 text-green-500 rounded-full flex items-center justify-center group-hover:bg-green-500 group-hover:text-white transition-all">
